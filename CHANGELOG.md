...
- Fix [#975](https://github.com/squint-cljs/squint/issues/975): `& {:keys [...]}` now destructures a map instead of the raw rest args. Both the kwargs and trailing-map call styles work, via `seq-to-map-for-destructuring`
